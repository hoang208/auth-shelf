    ...
    <div className="container">
      ...
      {shelf.map((item) => (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input id="description" name="description" onChange={handleDescriptionChange} required></input> 
          <label htmlFor="imageLink">Image Link:</label> 
          <input type="url" id="imageLink" name="imageLink" onChange={handleImageChange} required />
